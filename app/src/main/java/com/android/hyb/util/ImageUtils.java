...
public final class ImageUtils {
    ...
    public static Bitmap getBitmap(@DrawableRes final int resId) {
        Drawable drawable = ContextCompat.getDrawable(BaseApp.getContext(), resId);
    ...
    public static Bitmap renderScriptBlur(final Bitmap src,
        ...
        Bitmap ret = recycle ? src : src.copy(src.getConfig(), true);
        try {
            rs = RenderScript.create(BaseApp.getContext());
    ...
    public static int[] reCalculateImage(View imageView, int picWidth, int picHeight,
                                         int imgWidth) {
    ...
    public static int[] reCalculateImageHeigh(View imageView, int picWidth, int picHeight,
                                              int imgHeight) {
        float ratio = (float) imgHeight / picHeight;
        int rWidth = (int) (picWidth * ratio);
        int rHeight = imgHeight;
        ViewGroup.LayoutParams ps = imageView.getLayoutParams();
        ps.width = rWidth;
        ps.height = rHeight;
        imageView.setLayoutParams(ps);
