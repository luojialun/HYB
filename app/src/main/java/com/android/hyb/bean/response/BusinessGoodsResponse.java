...
public class BusinessGoodsResponse extends BaseResponse {
    private List<BusinessGoodsBean> data;

    public List<BusinessGoodsBean> getData() {
        return data;
    }

    public void setData(List<BusinessGoodsBean> data) {
        this.data = data;
    }
